...
import 'package:crud/views/edit_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _deleteProduct(String productId) async {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('You have successfully deleted a wisata')));
    }
                  ...
                  Container(
                    child: Column(
                      children: [
                        ...
                        Text("Rp." + place['harga_tiket'].toString()),
                      ],
                    ),
                  ),
                ],
